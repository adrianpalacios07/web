...
document.addEventListener('DOMContentLoaded', function(){
	...
	if(document.querySelector("#formRecetPass")){		
		...
		formRecetPass.onsubmit = function(e) {
			...
			let strEmail = document.querySelector('#txtUsuarioReset').value;
			if(strEmail == "")
			{
				swal("Por favor", "Escribe el usuario ", "error");
				return false;
			}else{
				divLoading.style.display = "flex";
				...
				var ajaxUrl = base_url+'/Login/resetPassOff'; 
	...
	if(document.querySelector("#txtUsuario")){
		let txtUsuario = document.querySelector("#txtUsuario");
		txtUsuario.onkeyup = function(e){
			e.preventDefault();
			txtUsuario.value = txtUsuario.value.replace(" ","");
		}
	}
