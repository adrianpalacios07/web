...
<div class="container">
	<div class="row isotope-grid p-t-30">
				<div class="col-sm-6 col-md-4 col-lg-4 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg11 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Bocaditos
							</a>
						</div>
					</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="Assets/images/bocaditos-choco.webp" alt="IMG-PRODUCT">
							<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg11 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Bocaditos						
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 p-b-35 isotope-item men">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
